...
import { TRUST_LEVEL_STYLES } from '../../../shared/trust-constants'
...
export function TrustScoreBar({ trustScore, showDetails = true, onClick }: TrustScoreBarProps) {
  const styles = TRUST_LEVEL_STYLES[trustScore.level] || TRUST_LEVEL_STYLES.new
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-1.5">
        ...
        <span className={`text-xs font-bold ${styles.text}`}>{trustScore.score}/100</span>
      </div>
